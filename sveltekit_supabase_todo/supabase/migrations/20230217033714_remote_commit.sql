...
--
-- Name: users1; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW "public"."users1" AS
...
--
-- Name: TABLE "users1"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE "public"."users1" TO "anon";
GRANT ALL ON TABLE "public"."users1" TO "authenticated";
GRANT ALL ON TABLE "public"."users1" TO "service_role";
